...
<form action='InsertarProfesor.php' method='post' enctype='application/x-www-form-urlencoded' width='80%'>

<h4><p>Título profesional abreviado:<br><input type='text' name='titulo' min='0'></p>
<p>Nombre del profesor:<br><input type='text' name='nombre'></p>
...
<p>Contraseña para ingresar:<br><input type='password' name='contrasena' min='0'></p></h4>	
	<input type='submit' class='btn btn-primary btn-block' value='Registrar profesor'>
</form>
</center>
";
?>