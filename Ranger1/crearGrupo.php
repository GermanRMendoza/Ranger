...
echo "<form action='InsertarGrupo.php' method='post' enctype='application/x-www-form-urlencoded' width='80%'>
	...
	echo "<p><label>Profesor:</label>
	 ...
	 while ($filaP = mysqli_fetch_array($resultadoP)) {
	 	echo "<option value=".$filaP['id'].">".$filaP['nombre']."</option>";
            ...
            echo "<input type='submit' class='btn btn-primary btn-block' value='Crear grupo'>
          </form>";