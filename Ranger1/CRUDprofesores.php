...
echo "<center><h2>Profesores</h2></center><meta charset='utf8'";
...
<div class='container' align='center'>
	...
	while ($fila = mysqli_fetch_array($resultado)) {
			    ...
			    echo "<td><a href='actualizarProfesor.php?id=".$fila['id']."'>Actualizar-<img src='img/actualizar.jpg' width='10%'></a>   <a href='eliminarProfesor.php?id=".$fila['id']."'>Eliminar-<img src='img/eliminar.jpg' width='10%'></a></td>
    				</tr>";
			    $counter = $counter + 1;
          ...
          echo "</div>";   
            ...
            <br><br><br><br>
                <a href='AgregarProfesor.php' class='thumbnail' style='background-color: #50aaff; color: black;'>                    
                    <p><h3 style='color:white;'>Agregar profesor</h3></p>
                </a>
            </div>  ";
